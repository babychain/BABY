Contributing to BABY Core
============================

The BABY Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BABY Core project, and is not to be
confused with overall BABY Network Protocol consensus changes.

Whether a pull request is merged into BABY Core rests with the project merge
...
Patches that change BABY consensus rules are considerably more involved than
...
Where a patch set proposes to change the BABY consensus, it must have been
...
The project leader is the release manager for each BABY Core release.
