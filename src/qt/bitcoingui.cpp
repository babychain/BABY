                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BABY Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BABY address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and baby: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zBABY"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BABY Core"), this);
    aboutAction->setStatusTip(tr("Show information about BABY Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BABY"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BABY addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BABY addresses"));
    ...
    openAction->setStatusTip(tr("Open a BABY: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BABY Core help message to get a list with possible BABY command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BABY Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BABY network", "", count));
}
...
{
    QString strTitle = tr("BABY Core"); // default title
