...
/* Baby GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "BABY"
#define QAPP_ORG_DOMAIN "babychain.xyz"
#define QAPP_APP_NAME_DEFAULT "BABY-Qt"
#define QAPP_APP_NAME_TESTNET "BABY-Qt-testnet"
