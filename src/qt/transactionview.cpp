 ...
 */
    ...
    typeWidget->addItem(tr("Received BABY from zBABY"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zBABY"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zBABY));
