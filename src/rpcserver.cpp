...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BABY features */
        {"baby", "masternode", &masternode, true, true, false},
        {"baby", "listmasternodes", &listmasternodes, true, true, false},
        {"baby", "getmasternodecount", &getmasternodecount, true, true, false},
        {"baby", "masternodeconnect", &masternodeconnect, true, true, false},
        {"baby", "masternodecurrent", &masternodecurrent, true, true, false},
        {"baby", "masternodedebug", &masternodedebug, true, true, false},
        {"baby", "startmasternode", &startmasternode, true, true, false},
        {"baby", "createmasternodekey", &createmasternodekey, true, true, false},
        {"baby", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"baby", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"baby", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"baby", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"baby", "getmasternodescores", &getmasternodescores, true, true, false},
        {"baby", "mnbudget", &mnbudget, true, true, false},
        {"baby", "preparebudget", &preparebudget, true, true, false},
        {"baby", "submitbudget", &submitbudget, true, true, false},
        {"baby", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"baby", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"baby", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"baby", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"baby", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"baby", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"baby", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"baby", "checkbudgets", &checkbudgets, true, true, false},
        {"baby", "mnsync", &mnsync, true, true, false},
        {"baby", "spork", &spork, true, true, false},
        {"baby", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"baby", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> baby-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:55444/\n";
}
