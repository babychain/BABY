...
RESOURCES += src/qt/baby.qrc src/qt/baby_locale.qrc

TRANSLATIONS += src/qt/locale/baby_bg.ts \
                src/qt/locale/baby_de.ts \
                src/qt/locale/baby_en.ts \
                src/qt/locale/baby_es.ts \
                src/qt/locale/baby_fi.ts \
                src/qt/locale/baby_fr.ts \
                src/qt/locale/baby_it.ts \
                src/qt/locale/baby_ja.ts \
                src/qt/locale/baby_pl.ts \
                src/qt/locale/baby_pt.ts \
                src/qt/locale/baby_ru.ts \
                src/qt/locale/baby_sk.ts \
                src/qt/locale/baby_sv.ts \
                src/qt/locale/baby_vi.ts \
                src/qt/locale/baby_zh_CN.ts \
                src/qt/locale/baby_zh_TW.ts
