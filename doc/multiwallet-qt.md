...
In order to support loading of multiple wallets in baby-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is baby.cpp.
...
Changes to baby.cpp
----------------------
baby.cpp is the entry point into baby-qt, and as such, will require some minor modifications to provide hooks for
